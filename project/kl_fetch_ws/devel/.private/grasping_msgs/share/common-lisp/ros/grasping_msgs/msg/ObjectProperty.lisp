...
(cl:defmethod cl:initialize-instance :after ((m <ObjectProperty>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectProperty)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name grasping_msgs-msg:<ObjectProperty> is deprecated: use grasping_msgs-msg:ObjectProperty instead.")))
...
(cl:defmethod value-val ((m <ObjectProperty>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader grasping_msgs-msg:value-val is deprecated.  Use grasping_msgs-msg:value instead.")
  (value m))
