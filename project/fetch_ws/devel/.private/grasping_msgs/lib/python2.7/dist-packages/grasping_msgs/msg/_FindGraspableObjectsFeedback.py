...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.object.object.point_cluster.is_dense))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.object.object.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.object.object.name = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.object.object.support_surface = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.object.object.point_cluster.header.frame_id = str[start:end].decode('utf-8')
      else:
