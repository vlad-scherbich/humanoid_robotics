...
"""autogenerated by genpy from pr2_common_action_msgs/ArmMoveIKActionResult.msg. Do not edit."""
import sys
...
class ArmMoveIKActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "pr2_common_action_msgs/ArmMoveIKActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pr2_common_action_msgs/ArmMoveIKResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ArmMoveIKActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = pr2_common_action_msgs.msg.ArmMoveIKResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pr2_common_action_msgs.msg.ArmMoveIKResult()
