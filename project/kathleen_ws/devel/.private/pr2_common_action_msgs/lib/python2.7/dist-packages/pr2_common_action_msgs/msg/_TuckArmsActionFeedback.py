...
"""autogenerated by genpy from pr2_common_action_msgs/TuckArmsActionFeedback.msg. Do not edit."""
import sys
...
class TuckArmsActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "pr2_common_action_msgs/TuckArmsActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pr2_common_action_msgs/TuckArmsFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TuckArmsActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = pr2_common_action_msgs.msg.TuckArmsFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = pr2_common_action_msgs.msg.TuckArmsFeedback()
