...
if("TRUE" STREQUAL "TRUE")
  set(pr2_teleop_general_SOURCE_PREFIX /home/kathleen/catkin_ws/src/pr2_apps/pr2_teleop_general)
  set(pr2_teleop_general_DEVEL_PREFIX /home/kathleen/catkin_ws/devel/.private/pr2_teleop_general)
  ...
  set(pr2_teleop_general_INSTALL_PREFIX /home/kathleen/catkin_ws/install)
...
if(NOT "/home/kathleen/catkin_ws/src/pr2_apps/pr2_teleop_general/include " STREQUAL " ")
  set(pr2_teleop_general_INCLUDE_DIRS "")
  set(_include_dirs "/home/kathleen/catkin_ws/src/pr2_apps/pr2_teleop_general/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://ros.org/wiki/pr2_teleop_general " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/pr2_teleop_general' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pr2_teleop_general' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'pr2_teleop_general' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kathleen/catkin_ws/src/pr2_apps/pr2_teleop_general/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kathleen/catkin_ws/devel/.private/pr2_teleop_general/lib;/home/kathleen/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${pr2_teleop_general_dep}_FOUND)
      find_package(${pr2_teleop_general_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pr2_teleop_general_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
