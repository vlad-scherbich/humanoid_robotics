...
let GetSnapshotGoal = require('./GetSnapshotGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class GetSnapshotActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GetSnapshotGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetSnapshotActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = GetSnapshotGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new GetSnapshotGoal()
    }
...
module.exports = GetSnapshotActionGoal;
